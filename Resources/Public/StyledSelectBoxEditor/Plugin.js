...
var OptionWithStyle = (_temp = _class = function (_PureComponent) {
    _inherits(OptionWithStyle, _PureComponent);

    function OptionWithStyle() {
        _classCallCheck(this, OptionWithStyle);

        return _possibleConstructorReturn(this, (OptionWithStyle.__proto__ || Object.getPrototypeOf(OptionWithStyle)).apply(this, arguments));
    }

    _createClass(OptionWithStyle, [{
        key: "render",
...
exports.default = OptionWithStyle;
...
var SelectBox_Option_MultiLineWithStyle = (_temp = _class = function (_PureComponent) {
    _inherits(SelectBox_Option_MultiLineWithStyle, _PureComponent);

    function SelectBox_Option_MultiLineWithStyle() {
        _classCallCheck(this, SelectBox_Option_MultiLineWithStyle);

        return _possibleConstructorReturn(this, (SelectBox_Option_MultiLineWithStyle.__proto__ || Object.getPrototypeOf(SelectBox_Option_MultiLineWithStyle)).apply(this, arguments));
    }

    _createClass(SelectBox_Option_MultiLineWithStyle, [{
        key: 'render',
        value: function render() {
    ...
    return SelectBox_Option_MultiLineWithStyle;
}(_react.PureComponent), _class.propTypes = {
    label: _propTypes2.default.string.isRequired,
    style: _propTypes2.default.string,
...
var _OptionWithStyle2 = _interopRequireDefault(_OptionWithStyle);
...
var StyleSelectBoxEditor = (_temp2 = _class = function (_PureComponent) {
    ...
    function StyleSelectBoxEditor() {
        ...
        _classCallCheck(this, StyleSelectBoxEditor);

        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
        }

        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = StyleSelectBoxEditor.__proto__ || Object.getPrototypeOf(StyleSelectBoxEditor)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
            searchTerm: "",
            isLoading: false,
            selectBoxOptions: {}
        }, _this.handleSearchTermChange = function (searchTerm) {
            _this.setState({ searchTerm: searchTerm });
        }, _temp), _possibleConstructorReturn(_this, _ret);
    }

    _createClass(StyleSelectBoxEditor, [{
        ...
        key: 'loadSelectBoxOptions',
        value: function loadSelectBoxOptions() {
            var _this2 = this;
        ...
        value: function render() {
            ...
            return _react2.default.createElement(_reactUiComponents.SelectBox, {
                ...
                ListPreviewElement: _OptionWithStyle2.default
            });
        }
    }]);
...
var _StyledSelectBoxEditor = __webpack_require__(/*! ./StyledSelectBoxEditor */ "./src/StyledSelectBoxEditor.js");

var _StyledSelectBoxEditor2 = _interopRequireDefault(_StyledSelectBoxEditor);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _neosUiExtensibility2.default)("NeosRulez.Neos:StyledSelectBoxEditor", {}, function (globalRegistry) {
    ...
    editorsRegistry.set("NeosRulez/Neos/Inspector/Editors/StyledSelectBoxEditor", {
        component: _StyledSelectBoxEditor2.default
    });
});
